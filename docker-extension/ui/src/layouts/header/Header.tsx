...
export const Header = ({location, ...props}: {location: string}) => {
  ...
  return (<>
    ...
    <Link to={""} className={cnb("logo")}><Logo/></Link>
    <Help
      showModal={showModal}
