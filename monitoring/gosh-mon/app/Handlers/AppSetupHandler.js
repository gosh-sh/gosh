...
class AppSetupHandler extends AppHandler_1.default {
    ...
    async handle(debug) {
        ...
        ]), 'click branches link', /*20*/ () => this.click(`//a[${(0, Utils_1.or_hrefs)(`/o/${or}/r/${re}/branches`)}]`, this.longtimeout), 'wait for main br link', /*21*/ () => this.waitFor(`//a[${(0, Utils_1.or_hrefs)(`/o/${or}/r/${re}/tree/main`)}]`), 'count wanted branches', /*22*/ async () => { found.root = (await this.count(`//a[${(0, Utils_1.or_hrefs)(`/o/${or}/r/${re}/tree/${br}`)}]`)) == 1; }, 'branch exists', ...this.cond_ifnot(() => found.root, [
        ...
        ]), 'click branches link', /*34*/ () => this.click(`//a[${(0, Utils_1.or_hrefs)(`/o/${or}/r/${re}/branches`)}]`, this.longtimeout), 'wait for main br link', /*35*/ () => this.waitFor(`//a[${(0, Utils_1.or_hrefs)(`/o/${or}/r/${re}/tree/main`)}]`), ...this.for_each(this.branches, 'branches', (s) => [
