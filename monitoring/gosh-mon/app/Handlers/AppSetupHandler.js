...
class AppSetupHandler extends AppHandler_1.default {
    ...
    async handle(debug) {
        ...
        /* 9*/ async () => { found.org = (await this.count(`//a[@href='/${this.organization}']`)) == 1; }, ...this.cond_ifnot(() => found.org, [
        ...
        /*15*/ async () => { found.rep = (await this.count(`//a[@href='${ort}']`)) == 1; }, ...this.cond_ifelse(() => found.rep, [
        ...
        /*21*/ async () => { found.root = (await this.count(`//a[@href='${ort}/tree/${this.branch}']`)) == 1; }, ...this.cond_ifnot(() => found.root, [
        ...
        /*27*/ async () => { found.file = (await this.count(`//a[@href='${ort}/blobs/${bfn}' or @href='${ort}/blobs/view/${bfn}']`)) == 1; }, ...this.cond_ifnot(() => found.file, [
        ...
        /*34*/ () => this.waitFor(`//a[@href='${ort}/tree/main']`), ...this.for_each(this.branches, (s) => [
