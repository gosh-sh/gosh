...
export default class AppRotateHandler extends AppHandler {
    ...
    async handle(debug: boolean): Promise<MetricsMap> {
        ...
        return await this.doSteps(
            ...
            'wait for spinner gone',   /*14*/ () => this.waitForGone('svg.fa-spin', this.longtimeout),
            ...
            'wait for spinner gone',   /*20*/ () => this.waitForGone('svg.fa-spin', this.longtimeout),
            ...
            /*27*/ () => this.waitFor("svg.fa-copy", this.longtimeout),
