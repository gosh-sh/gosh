...
if (c['reverb_clean_old_s'])    app.reverb_clean_old_s = c['reverb_clean_old_s'];
if (c['reverb_clean_total_mb']) app.reverb_clean_total_mb = c['reverb_clean_total_mb'];
if (c['reverb_clean_file_cnt']) app.reverb_clean_file_cnt = c['reverb_clean_file_cnt'];
