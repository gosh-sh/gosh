...
class GoshAdapter_3_0_0 implements IGoshAdapter {
  private static instance: GoshAdapter_3_0_0
  ...
  static getInstance(
    ...
    if (!GoshAdapter_3_0_0.instance) {
      GoshAdapter_3_0_0.instance = new GoshAdapter_3_0_0(goshroot, goshaddr)
    }
    return GoshAdapter_3_0_0.instance
  }
  ...
  getVersion(): string {
    return GoshAdapter_3_0_0.version
  }
