...
class GoshAdapter_6_1_0 implements IGoshAdapter {
  ...
  static getInstance(
    ...
    if (!GoshAdapter_6_1_0.instance) {
      GoshAdapter_6_1_0.instance = new GoshAdapter_6_1_0(goshroot, goshaddr)
    }
    return GoshAdapter_6_1_0.instance
  }
  ...
  getVersion(): string {
    return GoshAdapter_6_1_0.version
  }
