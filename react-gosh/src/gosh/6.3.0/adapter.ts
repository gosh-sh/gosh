...
class GoshAdapter_6_3_0 implements IGoshAdapter {
    private static instance: GoshAdapter_6_3_0
    private auth?: { username: string; keys: KeyPair }

    static version: string = '6.3.0'
    ...
    static getInstance(goshroot: IGoshRoot, goshaddr: TAddress): GoshAdapter_6_3_0 {
        if (!GoshAdapter_6_3_0.instance) {
            GoshAdapter_6_3_0.instance = new GoshAdapter_6_3_0(goshroot, goshaddr)
        }
        return GoshAdapter_6_3_0.instance
    }
    ...
    getVersion(): string {
        return GoshAdapter_6_3_0.version
    }
