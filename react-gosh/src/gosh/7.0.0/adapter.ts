...
class GoshAdapter_7_0_0 implements IGoshAdapter {
  private static instance: GoshAdapter_7_0_0
  ...
  static getInstance(
    ...
    if (!GoshAdapter_7_0_0.instance) {
      GoshAdapter_7_0_0.instance = new GoshAdapter_7_0_0(goshroot, goshaddr)
    }
    return GoshAdapter_7_0_0.instance
  }
  ...
  getVersion(): string {
    return GoshAdapter_7_0_0.version
  }
