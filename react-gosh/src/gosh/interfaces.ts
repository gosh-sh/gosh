...
interface IGoshAdapter {
  ...
  isValidUser(
    user: TUserParam,
  ): Promise<{ user: TUserParam; address: TAddress }>
...
interface IGoshDaoAdapter {
  ...
  getAddress(): TAddress
  getNext(): Promise<{ account: IGoshDaoAdapter; version: string } | null>
