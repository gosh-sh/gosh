...
class GoshWallet extends BaseContract implements IGoshWallet {
    ...
    async startProposalForSetCommit(
        ...
        const locker = new GoshSmvLocker(this.account.client, await this.getSmvLockerAddr(), this.version)
...
*/         proposalAddr: string,
       choice: boolean,
        ...
        const proposal = new GoshSmvProposal(this.account.client, proposalAddr, this.version)
        const locker = new GoshSmvLocker(this.account.client, await this.getSmvLockerAddr(), this.version)
