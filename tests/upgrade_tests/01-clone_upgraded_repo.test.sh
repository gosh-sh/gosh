...
TESTS_PATH=../../tests
REPO_NAME=repo01
DAO_NAME=dao-test-01
NEW_REPO_PATH=repo01_v2
CONTROL_REPO_PATH=repo01_control
...
echo "Test upgrade 01 old version: $OLD_VERSION"
...
DAO_NAME="dao-test01_$TEST_INDEX"
