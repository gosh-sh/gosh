...
echo "> Run setProfile"
tonos-cli -u $NETWORK callx --abi $VERSIONCONTROLLER_ABI --addr $VERSIONCONTROLLER_ADDR --keys "$seed" -m setProfile "{\"code\": \"$PROFILE_CODE\"}"
echo "> Run setProfileIndex"
tonos-cli -u $NETWORK callx --abi $VERSIONCONTROLLER_ABI --addr $VERSIONCONTROLLER_ADDR --keys "$seed" -m setProfileIndex "{\"code\": \"$PROFILEINDEX_CODE\"}"
echo "> Run setProfileDao"
tonos-cli -u $NETWORK callx --abi $VERSIONCONTROLLER_ABI --addr $VERSIONCONTROLLER_ADDR --keys "$seed" -m setProfileDao "{\"code\": \"$PROFILEDAO_CODE\"}"
