...
abstract contract SMVConfiguration is ReplayProtection {   
    string constant versionSMVCONF = "6.3.0";
...
//    uint256 constant CHANGE_TOKEN_CONFIG_PROPOSAL_KIND = 8;
    ...
    uint256 constant CREATE_TAG_KIND = 47;
    ...
    uint256 constant TRANSFER_DAO_TIP3_KIND = 55;
    uint256 constant DEPLOY_BRANCH_KIND = 56;
    uint256 constant SET_ALLOWED_PROPOSAL_WITH_TAG_KIND = 57;
    uint256 constant DESTROY_TOPIC_KIND = 57;
}