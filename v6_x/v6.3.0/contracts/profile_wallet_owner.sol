...
contract ProfileWalletOwner is Modifiers {
    string constant version = "1.0.0";
    mapping(uint8 => TvmCell) _code;
    
    address static _versioncontroller;
    string static _reponame;
    address static _pubaddr;
    ...
    function turnOn(address wallet, uint256 pubkey) public onlyOwnerPubkeyList accept saveMsg {
        ...
        uint32 mask;
        mask = _incMaskValue(mask, _owners[msg.pubkey()]);
        _messages[_generateId()] = MessageProfile(3, block.timestamp + _expTime, mask, 1, pubkey, wallet, null, null, null, null, null);
    }
    ...
    function turnOff(address wallet) public onlyOwnerPubkeyList accept saveMsg {
        ...
        uint32 mask;
        mask = _incMaskValue(mask, _owners[msg.pubkey()]);
        _messages[_generateId()] = MessageProfile(4, block.timestamp + _expTime, mask, 1, null, wallet, null, null, null, null, null);
    }
