...
interface IObject {
    ...
    function returnRepo(string, string, Branch[], string, mapping(uint256 => string), bool, optional(string), optional(Grants[]), optional(uint128), optional(address), string) external;
...
abstract contract Modifiers is ReplayProtection {   
    string constant versionModifiers = "7.0.0";
    ...
    uint8 constant m_ProfileDaoLastCode = 29;
    ...
    uint128 constant CURRENCIES_DECIMALS = 1e9;
