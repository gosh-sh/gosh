...
export class DaoWallet extends BaseContract {
  ...
  async getEventAddress(result: ResultOfProcessMessage) {
    ...
    const prop_id =
      await AppConfig.goshroot.getEventPropIdFromCell(static_cell);
  ...
  async updateDaoAskMembership(params: {
    ...
    if (cell) {
      ...
      const cell: any = await this.updateDaoAskMembership({
        ...params,
        cell: true,
      });
      return await this.createSingleEvent({ cell, reviewers });
  ...
  async disableMintDaoTokens(params: {
    ...
    if (cell) {
      ...
      const cell: any = await this.disableMintDaoTokens({
        ...params,
        cell: true,
      });
      return await this.createSingleEvent({ cell, reviewers });
  ...
  async addDaoVotingTokens(params: {
    ...
    if (cell) {
      ...
      const cell: any = await this.addDaoVotingTokens({
        ...params,
        cell: true,
      });
      return await this.createSingleEvent({ cell, reviewers });
  ...
  async addDaoRegularTokens(params: {
    ...
    if (cell) {
      ...
      const cell: any = await this.addDaoRegularTokens({
        ...params,
        cell: true,
      });
      return await this.createSingleEvent({ cell, reviewers });
  ...
  async createRepositoryTag(params: {
    ...
    if (cell) {
      ...
      const cell: any = await this.createRepositoryTag({
        ...params,
        cell: true,
      });
      return await this.createSingleEvent({ cell, reviewers });
  ...
  async deleteRepositoryTag(params: {
    ...
    if (cell) {
      ...
      const cell: any = await this.deleteRepositoryTag({
        ...params,
        cell: true,
      });
      return await this.createSingleEvent({ cell, reviewers });
  ...
  async receiveTaskRewardAsDao(params: {
    ...
    if (cell) {
      ...
      const cell: any = await this.receiveTaskRewardAsDao({
        ...params,
        cell: true,
      });
      return await this.createSingleEvent({ cell, reviewers });
  ...
  async sendTokensAsDao(params: {
    ...
    if (cell) {
      const { value0 } = await this.runLocal(
        "getCellForSendDaoToken",
        cellParams,
      );
      return value0 as string;
    } else {
      const cell: any = await this.sendTokensAsDao({
        ...params,
        cell: true,
      });
      return await this.createSingleEvent({ cell, reviewers });
  ...
  async createRepositoryBranch(params: {
    ...
    if (cell) {
      ...
      const cell: any = await this.createRepositoryBranch({
        ...params,
        cell: true,
      });
      return await this.createSingleEvent({ cell, reviewers });
  ...
  async createHackathon(params: {
    ...
    if (cell) {
      ...
      const cell_data: any = await this.createHackathon({
        ...params,
        cell: true,
      });
      return await this.createSingleEvent({ cell: cell_data, reviewers });
  ...
  async updateHackathon(params: {
    ...
    if (cell) {
      const { value0 } = await this.runLocal(
        "getCellAddCurrencies",
        cell_params,
      );
      return value0 as string;
    } else {
      const cell_data: any = await this.updateHackathon({
        ...params,
        cell: true,
      });
      return await this.createSingleEvent({ cell: cell_data, reviewers });
