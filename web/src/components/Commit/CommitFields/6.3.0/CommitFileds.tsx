...
import { TPushProgress, TTaskDetails, classNames, useTaskList } from 'react-gosh'
    ...
    <div className={classNames('border border-gray-e6edff rounded-xl py-5', className)}>
      ...
      >
        ...
        <div className="basis-5/12 px-5">
          ...
          <div className="mt-6">
            <label className="block mb-2 font-medium text-gray-7c8db5">Assigners</label>
            <UserSelect
              gosh={dao.getGosh()}
          ...
          <div className="mt-6">
            <label className="block mb-2 font-medium text-gray-7c8db5">Reviewers</label>
            <UserSelect
              gosh={dao.getGosh()}
          ...
          <div className="mt-6">
            <label className="block mb-2 font-medium text-gray-7c8db5">Managers</label>
            <UserSelect
              gosh={dao.getGosh()}
