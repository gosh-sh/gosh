...
const HackathonApplicationFormUpdate = (
  props: THackathonApplicationFormUpdateProps,
) => {
  ...
  return (
    <Dialog.Panel className="relative rounded-xl bg-white p-10 w-full max-w-sm overflow-hidden">
      <Formik
        initialValues={{
          ...initial_values,
          fields: initial_values.fields.map((v) => ({
            _motion_id: Math.random(),
            ...v,
          })),
          owners: initial_values.owners.map((v) => ({
            label: v.name,
            value: v,
          })),
        }}
      ...
      >
        {({ isSubmitting, errors, values, setFieldValue }) => (
          <Form>
            ...
            <div className="mb-6">
              <h4 className="mb-2 text-sm text-gray-7c8db5">
