          ...
          <Form>
            <Tab.Group>
              ...
              >
                <Tab.Panel>
                  <div>
                    <h2 className="mb-4 text-xl font-medium">Amount</h2>
                    <Field
                  ...
                  >
                    <h2 className="mb-4 text-xl font-medium">Prize places</h2>
                    <div
...
const FieldArrayForm = (props: TFieldArrayFormProps) => {
  ...
  return (
    <div className="py-5">
      <div
        ref={ref}
        className="px-6 flex flex-col gap-y-4 h-48 overflow-y-auto"
      >
        <AnimatePresence>
