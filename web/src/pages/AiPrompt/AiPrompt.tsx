            ...
            <div className="basis-auto grow-0">
                ...
                >
                    <div className="grow">
                        ...
                        <div className="mt-2 text-sm text-gray-53596d">
                            GoshAI organization
                        </div>
                    </div>
                    <div>
    ...
    const onFormSubmit = async (values: { repo_name: string; email: string }) => {
        ...
        try {
            ...
            if (!isMember) {
                throw new GoshError(
                    'Accesss denied',
                    `You are not a member of DAO '${daoName}'`,
                )
            }
            ...
            if (!isAiMember) {
                if (members.length === 1) {
                    await dao.createMember({
                        alone: true,
                        members: [
                            { user: aiUser, allowance: 0, comment: '', expired: 0 },
                        ],
                    })
                } else {
                    throw new GoshError(
                ...
                <div className="basis-0 grow relative overflow-x-auto md:overflow-x-visible">
                    ...
                    >
                        ...
                        <div className="mt-4 text-sm text-center md:max-w-[70%] mx-auto">
                            To get started with GOSH.AI, upload your Spec.MD file with a
                            description of your project, answer questions GOSH.AI might
                            have and wait for first Pull Request from a team of GOSH
                            Artificial Intelligence Models which will work for you to
                            write, test and deploy your project
                        </div>
