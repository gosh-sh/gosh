...
const RepoPage = () => {
  ...
  return (
    <div className="grow flex flex-row flex-wrap lg:flex-nowrap min-h-full">
      <div className="grow container basis-1 container border-[#d6d9e1] border-0 min-h-full border-r-[1px]">
        <div className=" flex flex-row justify-between align-middle">
          <h3 className="font-semibold text-xl font">
            Stages{" "}
            <FontAwesomeIcon
              icon={faInfoCircle}
          ...
          <Menu as="div" className="relative">
            <Menu.Button>
              <Button test-id="btn-add-stage" variant="secondary">
                <FontAwesomeIcon
                  icon={faPlus}
                  className="w-[18px] h-[18px] align-[-0.25rem]"
                />
