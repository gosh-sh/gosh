            ...
            <Formik
                ...
                validationSchema={yup.object().shape({
                    ...
                    assign: yup
                        ...
                        .test(
                            'test-percent',
                            'Percent sum should be 100%',
                            function (value) {
                                if (
                                    value + this.parent.review + this.parent.manager !==
                                    100
                                ) {
                                    return false
                                }
                    ...
                    review: yup
                        ...
                        .test(
                            ...
                            function (value) {
                                if (
                                    value + this.parent.assign + this.parent.manager !==
                                    100
                                ) {
                                    return false
                                }
                    ...
                    manager: yup
                        ...
                        .test(
                            ...
                            function (value) {
                                if (
                                    value + this.parent.assign + this.parent.review !==
                                    100
                                ) {
                                    return false
                                }
                            ...
                            <div className="mb-4">
                                ...
                                >
                                    <AsyncSelect
                                        ...
                                        isClearable
                                        isDisabled={
                                            isSubmitting || repositoryList.data.isFetching
                                        }
                                        isLoading={repositoryList.data.isFetching}
                                        cacheOptions
                                        defaultOptions={repositoryList.data.items.map(
                                            ({ name }) => ({
                                                label: name,
                                                value: name,
                                            }),
