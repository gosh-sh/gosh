...
const DaoHackatonListPage = (props: { count?: number }) => {
    const { count = 10 } = props
    const navigate = useNavigate()
    const dao = useDao()
    const member = useDaoMember()
    const hackatons = useDaoHackatonList()
    ...
    const onCreateClick = (type: EHackatonType) => {
                        ...
                        <Menu as="div" className="relative">
                            ...
                            >
                                <Menu.Item
                                    ...
                                    onClick={() => onCreateClick(EHackatonType.HACKATON)}
                                >
                                    <FontAwesomeIcon
                                        icon={faComment}
                                        fixedWidth
                                ...
                                <Menu.Item
                                    ...
                                    onClick={() => onCreateClick(EHackatonType.GRANT)}
                                >
                                    <FontAwesomeIcon
                                        icon={faTrophy}
                                        fixedWidth
...
export default DaoHackatonListPage
