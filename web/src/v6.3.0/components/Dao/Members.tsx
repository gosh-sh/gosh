    ...
    <div className={classNames('border border-gray-e6edff rounded-xl p-5', className)}>
      ...
      <div>
        ...
        {member.isMember && (
          <div className="flex flex-col gap-y-2 items-center">
            ...
            >
              <FontAwesomeIcon icon={faPlus} size="sm" fixedWidth className="mr-2" />
              Invite members
            </Link>
            <CopyClipboard
              label={
                <>
                  <FontAwesomeIcon icon={faCopy} size="sm" fixedWidth className="mr-2" />
                  Copy invite link
                </>
              }
      ...
      {!member.isMember && !dao.details.isAskMembershipOn && (
        <div className="border-t border-gray-e6edff pt-5">
          <h3 className="mb-4 text-lg font-medium">This is a private organization</h3>
