        ...
        <div>
          ...
          {event.data && (
            <div className="overflow-clip">
              ...
              {event.type === EDaoEventType.DAO_ASK_MEMBERSHIP_ALLOWANCE && (
              ...
              {event.type === EDaoEventType.DAO_MEMBER_EXPERT_TAG_CREATE && (
                <DaoMemberExpertTagCreateEvent data={event.data} />
              )}
              {event.type === EDaoEventType.DAO_MEMBER_EXPERT_TAG_DELETE && (
