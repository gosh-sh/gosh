...
const DaoLayout = () => {
  ...
  const getTabs = () => {
    ...
    if (member.isMember) {
      ...
      tabs.push({ to: `/o/${daoname}/ic/create`, title: 'Integrity Credits', order: 8 })
    }
    ...
    <div className="container py-10">
      <div className="row mb-6">
        ...
        <div className="col overflow-hidden">
          <h1>
            <Link to={`/o/${daoname}`} className="font-medium text-2xl capitalize">
              {daoname}
            </Link>
            <span
          ...
          <CopyClipboard
            ...
            label={
              <span data-tooltip-id="common-tip" data-tooltip-content="DAO address">
