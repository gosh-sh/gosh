  ...
  return (
    <Formik
      ...
      validationSchema={yup.object().shape({
        ...
        from_amount: yup.number().min(0.011).max(parseFloat(maxBalance)).required(),
    ...
    >
      {({ values }) => (
        <Form>
          ...
          >
            <div className="basis-full lg:basis-2/12 text-xl font-medium">From</div>
            <div className="grow">
            ...
            <div className="hidden lg:block self-end">
              <div className="w-[5.625rem]">
                <img src="/images/bridge-from.webp" alt="From blockchain" />
              </div>
            </div>
          </div>
          ...
          <div
            className="mt-5 flex flex-wrap lg:flex-nowrap gap-x-12 gap-y-6
                            border border-gray-e6edff rounded-xl bg-gray-fafafd p-5"
          >
            <div className="basis-full lg:basis-2/12 text-xl font-medium">To</div>
            <div className="grow">
              <div className="flex items-end flex-nowrap gap-x-5">
                <div className="grow">
                  <TokenField
